...
def generate_launch_description():
    ...
    declares = [
        ...
        DeclareLaunchArgument('use_sim_time', default_value='false', description='回放bag设为true'),
        DeclareLaunchArgument('use_tf',       default_value='false', description='是否发布静态TF base_link->rslidar'),
        ...
        DeclareLaunchArgument('lidar_z',      default_value='1.70'),
